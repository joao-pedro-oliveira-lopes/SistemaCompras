...
//Estou utilizando o D de domínio
//Utilizado tanto para DbSet quanto para o onModelCreating 
using SolicitacoesCompraD = SistemaCompra.Domain.SolicitacaoCompraAggregate.SolicitacaoCompra;
...
namespace SistemaCompra.Infra.Data
{
    public class SistemaCompraContext : DbContext
    {
        ...
        public DbSet<SolicitacoesCompraD> SolicitacoesCompra { get; set; }
